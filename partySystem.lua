-- basic setup
local PlayerActivationApi = require("custom.playerActivateAPI")
...
local function hideButton()
    partyButton.displayConditions = {{
        conditionType = "hidden"
    }}
end

local function showButton()
    partyButton.displayConditions = nil
end
...
function PartySystem.onPlayerActivateHandler(eventStatus, me, them, cellDescription)
