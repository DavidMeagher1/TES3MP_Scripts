local function assignToGlobal(PartySystem)
    PartySystem.CopyTopicsToParty = function(pid)
    ...
    PartySystem.OnPlayerTopicValidator = function(eventStatus,pid)
    return customEventHooks.makeEventStatus(false,true)
    end
    PartySystem.OnPlayerTopicHandler = function(eventStatus,pid)
