 local function assignTOGlobalPartySystem(PartySystem)

    PartySystem.CopyJournalToParty = function(pid)
    ...
    PartySystem.OnPlayerJournalValidator = function(eventstatus, pid)
        return customEventHooks.makeEventStatus(false, true)
    end

    PartySystem.OnPlayerJournalHandler = function(eventStatus, pid)
...
return assignTOGlobalPartySystem